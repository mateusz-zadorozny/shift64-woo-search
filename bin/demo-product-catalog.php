...
if ( ! class_exists( 'Shift64_Woo_Search_Demo_Catalog' ) ) {
	...
	class Shift64_Woo_Search_Demo_Catalog {
		...
		public static function prefixes() {
			return array(
				'Aero', 'Alto', 'Arc', 'Aura', 'Axis', 'Bold', 'Calm', 'Core',
				'Crest', 'Drift', 'Echo', 'Edge', 'Flux', 'Forge', 'Halo', 'Lumen',
				'Nova', 'Onyx', 'Orbit', 'Prime', 'Pulse', 'Quill', 'Ridge', 'Vertex',
			);
		}
		...
		private static function apparel_vertical() {
			return array(
				...
				'series'     => array(
					'Athena', 'Apollo', 'Artemis', 'Atlas', 'Calypso', 'Circe', 'Daphne', 'Demeter',
					'Echo', 'Gaia', 'Hector', 'Hera', 'Hermes', 'Iris', 'Leto', 'Maia',
					'Nike', 'Orion', 'Selene', 'Themis',
				),
				'items'      => array(
					array( 'name' => 'T-Shirt', 'category' => 't_shirts', 'price' => 29.90 ),
					array( 'name' => 'Polo Shirt', 'category' => 't_shirts', 'price' => 39.90 ),
					array( 'name' => 'Oxford Shirt', 'category' => 'shirts', 'price' => 54.90 ),
					array( 'name' => 'Hoodie', 'category' => 'hoodies', 'price' => 74.90 ),
					array( 'name' => 'Zip Hoodie', 'category' => 'hoodies', 'price' => 79.90 ),
					array( 'name' => 'Sweater', 'category' => 'sweaters', 'price' => 69.90 ),
					array( 'name' => 'Cardigan', 'category' => 'sweaters', 'price' => 84.90 ),
				...
				'specs'      => array(
					'Relaxed Fit', 'Slim Fit', 'Oversized', 'Tailored', 'Cropped', 'Longline',
					'Everyday', 'Heavyweight', 'Lightweight', 'Brushed', 'Ribbed', 'Quilted',
				),
				'finishes'   => array(
					'Midnight Black', 'Deep Navy', 'Slate Grey', 'Off White', 'Cream', 'Sand',
					'Olive', 'Forest Green', 'Burgundy', 'Rust', 'Cobalt Blue', 'Lilac',
					'Blush Pink', 'Mustard', 'Terracotta', 'Charcoal',
				),
				'variation'  => array(
					'label'  => 'Size',
					'slug'   => 'size',
		...
		private static function tech_vertical() {
			return array(
				...
				'series'     => array(
					'Aurora', 'Beacon', 'Cipher', 'Delta', 'Ember', 'Falcon', 'Gravity', 'Horizon',
					'Ion', 'Kelvin', 'Lattice', 'Meridian', 'Nimbus', 'Photon', 'Quantum', 'Radian',
					'Spectra', 'Tesseract', 'Vector', 'Zenith',
				),
				'items'      => array(
					array( 'name' => 'Headphones', 'category' => 'headphones', 'price' => 199.00 ),
					array( 'name' => 'Studio Headphones', 'category' => 'headphones', 'price' => 349.00 ),
					array( 'name' => 'Earbuds', 'category' => 'earbuds', 'price' => 129.00 ),
					array( 'name' => 'Speaker', 'category' => 'speakers', 'price' => 179.00 ),
					array( 'name' => 'Microphone', 'category' => 'microphones', 'price' => 149.00 ),
					array( 'name' => 'Laptop', 'category' => 'laptops', 'price' => 1299.00 ),
					array( 'name' => 'Monitor', 'category' => 'monitors', 'price' => 429.00 ),
					array( 'name' => 'Keyboard', 'category' => 'keyboards', 'price' => 119.00 ),
					array( 'name' => 'Mouse', 'category' => 'mice', 'price' => 69.00 ),
					array( 'name' => 'Gaming Mouse', 'category' => 'mice', 'price' => 99.00 ),
					array( 'name' => 'Smartphone', 'category' => 'smartphones', 'price' => 899.00 ),
					array( 'name' => 'Tablet', 'category' => 'tablets', 'price' => 649.00 ),
					array( 'name' => 'Smartwatch', 'category' => 'smartwatches', 'price' => 279.00 ),
					array( 'name' => 'Power Bank', 'category' => 'powerbanks', 'price' => 59.00 ),
				),
				'specs'      => array(
					'Pro', 'Max', 'Lite', 'Studio', 'Compact', 'Wireless',
					'Noise Cancelling', 'High Fidelity', 'Ultra Wide', 'Low Latency', 'Fast Charge', 'Travel',
				),
				'finishes'   => array(
					'Space Grey', 'Matte Black', 'Silver', 'Graphite', 'Titanium', 'Arctic White',
					'Midnight Blue', 'Copper', 'Sage', 'Sunset Orange', 'Ruby Red', 'Steel',
					'Onyx', 'Pearl', 'Bronze', 'Ice Blue',
				),
				'variation'  => array(
					'label'  => 'Capacity',
					'slug'   => 'capacity',
		...
		private static function home_vertical() {
			return array(
				...
				'series'     => array(
					'Alder', 'Basalt', 'Cedar', 'Dune', 'Elm', 'Fjord', 'Granite', 'Harbor',
					'Ivory', 'Juniper', 'Kiln', 'Linden', 'Meadow', 'Nordic', 'Opal', 'Quarry',
					'Sable', 'Timber', 'Umber', 'Willow',
				),
				'items'      => array(
					array( 'name' => 'Office Chair', 'category' => 'chairs', 'price' => 249.00 ),
					array( 'name' => 'Lounge Chair', 'category' => 'chairs', 'price' => 399.00 ),
					array( 'name' => 'Desk', 'category' => 'desks', 'price' => 329.00 ),
					array( 'name' => 'Standing Desk', 'category' => 'desks', 'price' => 599.00 ),
					array( 'name' => 'Dining Table', 'category' => 'tables', 'price' => 749.00 ),
					array( 'name' => 'Side Table', 'category' => 'tables', 'price' => 159.00 ),
					array( 'name' => 'Bookshelf', 'category' => 'bookshelves', 'price' => 279.00 ),
					array( 'name' => 'Desk Lamp', 'category' => 'desk_lamps', 'price' => 79.00 ),
					array( 'name' => 'Floor Lamp', 'category' => 'floor_lamps', 'price' => 139.00 ),
					array( 'name' => 'Pendant Light', 'category' => 'pendant_lights', 'price' => 119.00 ),
					array( 'name' => 'Coffee Maker', 'category' => 'coffee_makers', 'price' => 189.00 ),
					array( 'name' => 'Espresso Machine', 'category' => 'coffee_makers', 'price' => 449.00 ),
					array( 'name' => 'Kettle', 'category' => 'kettles', 'price' => 69.00 ),
					array( 'name' => 'Cookware Set', 'category' => 'cookware', 'price' => 219.00 ),
				),
				'specs'      => array(
					'Compact', 'Extended', 'Adjustable', 'Foldable', 'Modular', 'Handcrafted',
					'Matte', 'Glossy', 'Insulated', 'Stackable', 'Studio', 'Heritage',
				),
				'finishes'   => array(
					'Natural Oak', 'Walnut', 'Ash Grey', 'Matte Black', 'Brushed Steel', 'Brass',
					'Chalk White', 'Clay', 'Moss Green', 'Deep Teal', 'Warm Sand', 'Ink Blue',
					'Copper', 'Marble', 'Bamboo', 'Linen',
				),
				'variation'  => array(
					'label'  => 'Material',
					'slug'   => 'material',
		...
		private static function beauty_vertical() {
			return array(
				...
				'series'     => array(
					'Amber', 'Bloom', 'Cascade', 'Dewdrop', 'Elixir', 'Flora', 'Glow', 'Hydra',
					'Infuse', 'Jasmine', 'Lotus', 'Mineral', 'Nectar', 'Orchid', 'Petal', 'Radiance',
					'Serene', 'Tonic', 'Velvet', 'Zest',
				),
				'items'      => array(
					array( 'name' => 'Face Serum', 'category' => 'serums', 'price' => 49.00 ),
					array( 'name' => 'Night Serum', 'category' => 'serums', 'price' => 59.00 ),
					array( 'name' => 'Moisturiser', 'category' => 'moisturisers', 'price' => 39.00 ),
					array( 'name' => 'Day Cream', 'category' => 'moisturisers', 'price' => 44.00 ),
					array( 'name' => 'Cleanser', 'category' => 'cleansers', 'price' => 29.00 ),
					array( 'name' => 'Micellar Cleanser', 'category' => 'cleansers', 'price' => 25.00 ),
					array( 'name' => 'Face Mask', 'category' => 'masks', 'price' => 22.00 ),
					array( 'name' => 'Sheet Mask', 'category' => 'masks', 'price' => 12.00 ),
					array( 'name' => 'Shampoo', 'category' => 'shampoos', 'price' => 24.00 ),
					array( 'name' => 'Volume Shampoo', 'category' => 'shampoos', 'price' => 27.00 ),
					array( 'name' => 'Conditioner', 'category' => 'conditioners', 'price' => 26.00 ),
					array( 'name' => 'Styling Oil', 'category' => 'styling_oils', 'price' => 34.00 ),
					array( 'name' => 'Eau de Parfum', 'category' => 'eau_de_parfum', 'price' => 89.00 ),
					array( 'name' => 'Eau de Toilette', 'category' => 'eau_de_toilette', 'price' => 69.00 ),
				),
				'specs'      => array(
					'Hydrating', 'Brightening', 'Soothing', 'Repairing', 'Purifying', 'Nourishing',
					'Fragrance Free', 'Daily', 'Intensive', 'Overnight', 'Lightweight', 'Rich',
				),
				'finishes'   => array(
					'Rose', 'Neroli', 'Vetiver', 'Bergamot', 'Sandalwood', 'Vanilla',
					'Green Tea', 'Aloe', 'Citrus', 'Lavender', 'Coconut', 'Almond',
					'Cedarwood', 'Peony', 'Mint', 'Amber Musk',
				),
				'variation'  => array(
					'label'  => 'Capacity',
					'slug'   => 'capacity',
