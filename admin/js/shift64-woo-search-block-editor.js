	...
	var addModalSearchControls = function ( settings, name ) {
		...
		return Object.assign( {}, settings, {
			edit: function ( props ) {
				...
				var colorControl = function ( label, attribute, enableAlpha ) {
				...
				return createElement(
					...
					createElement(
						...
						createElement(
							...
							colorControl( __( 'Icon color', 'shift64-woo-search' ), 'trigger_icon_color' ),
							colorControl( __( 'Icon hover color', 'shift64-woo-search' ), 'trigger_icon_hover_color' ),
							colorControl( __( 'Background or outline color', 'shift64-woo-search' ), 'trigger_surface_color' ),
							colorControl( __( 'Background or outline hover color', 'shift64-woo-search' ), 'trigger_surface_hover_color' )
						),
						createElement(
							PanelBody,
							{
							...
							colorControl( __( 'Modal background color', 'shift64-woo-search' ), 'modal_background_color', true )
						)
					),
					createElement(
						InspectorControls,
