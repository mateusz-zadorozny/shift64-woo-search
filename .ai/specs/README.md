...
| [Product Search Relevance Browser Test](2026-08-28-product-search-relevance-browser-test.md) | ✅ implemented | PR #99 (follow-up to merged PR #90); the mobile no-overflow assertion ships as a documented `test.fail()` pending issue #101 |
